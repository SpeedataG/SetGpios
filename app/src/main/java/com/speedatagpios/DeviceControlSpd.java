...
public class DeviceControlSpd {
    ...
    /**
     * MTK(6873)平台安卓11版本  主板上电路径(例如：FG50、FG60)
     */
    ...
    /**
     * MTK(6873)平台安卓11版本  上电(例如：FG50、FG60)
     *
     * @param gpio
     * @throws IOException
     */
    public void newFgSetGpioOn(int gpio) throws IOException {
        DeviceControlSpd deviceControl = new DeviceControlSpd(POWER_NEWMAIN_FG);
        //将GPIO设置为高电平
        deviceControl.ctrlfile.write("out " + gpio + " 1");
        deviceControl.ctrlfile.flush();
        newFgSetMode(gpio);
    ...
    /**
     * MTK(6873)平台安卓11版本  下电(例如：FG50、FG60)
     *
     * @param gpio
     * @throws IOException
     */
    ...
    /**
     * MTK(6873)平台安卓11版本  设置当前gpio为gpio模式(例如：FG50、FG60)
     *
     * @param gpio 设置gpio
     * @throws IOException
     */
    ...
    /**
     * MTK(6873)平台安卓11版本  设置当前gpio为输入/输出模式(例如：FG50、FG60)
     *
     * @param gpio 要操作的gpio
     * @param dir  0：输入模式  1：输出模式
     * @throws IOException
