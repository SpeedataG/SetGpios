...
import com.speedatagpios.BuildConfig;
...
public final class Logcat {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = AppSet.getInstance().getPackageManager()
                    .getPackageInfo(AppSet.getInstance().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && AppSet.getInstance().getExternalCacheDir() != null) {
                sDefaultDir = AppSet.getInstance().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                sDefaultDir = AppSet.getInstance().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
